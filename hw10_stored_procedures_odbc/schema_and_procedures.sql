...
CREATE DATABASE HW10 CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
USE HW10;
...
DELIMITER $$
CREATE PROCEDURE GetCustomerOrders(IN cName VARCHAR(100))
BEGIN
	SELECT
		o.order_id,
        o.order_date,
        SUM(oi.quantity * oi.unit_price) AS totalOrderValue
	FROM Customers c
...
CALL GetCustomerOrders('Alice Smith');

-- Before updating salary
SELECT name, salary FROM Staff;

CALL UpdateSalaryByRole('Sales Rep', 10);
